<div class="container-fluid">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white"><?= $total_anggota; ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white"><?= $total_stok_buku; ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white"><?= $total_dipinjam; ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white"><?= $total_dibooking; ?></div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row">
        <div class="table-responsive table-bordered col-sm-6 ml-auto mr-auto mt-2"> <div class="page-header">
