                ...
                <div class="navbar-nav">
                    ...
                    <?php if (session()->get('email')) : ?>
                        <a class="nav-item nav-link" href="<?= base_url('booking'); ?>">
                            Booking <b><?= $count_temp; ?></b> Buku
                        </a>
                        
                        <a class="nav-item nav-link" href="<?= base_url('user'); ?>">Profil Saya</a>
                        <a class="nav-item nav-link" href="<?= base_url('autentifikasi/logout'); ?>"><i class="fas fw fa-sign-out-alt"></i> Log out</a>
                    <?php else : ?>
                        <a class="nav-item nav-link" data-toggle="modal" data-target="#daftarModal" href="#"><i class="fas fw fa-user-plus"></i> Daftar</a>
                    ...
                    <span class="nav-item nav-link nav-right" style="display:block; margin-left:20px;">
                        Selamat Datang <b><?= (isset($user['nama'])) ? $user['nama'] : 'Pengunjung'; ?></b>
                    </span>
                </div>
            </div>
        </div>
