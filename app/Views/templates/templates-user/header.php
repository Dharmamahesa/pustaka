            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <?php if (session()->get('email')) : ?>
                        <a class="nav-item nav-link" href="<?= base_url('booking'); ?>">Booking <b><?= $this->ModelBooking->getDataWhere('temp', ['email_user' => session()->get('email')])->num_rows(); ?></b> Buku</a>
                    ...
                    <span class="nav-item nav-link nav-right" style="display:block; margin-left:20px;">Selamat Datang <b><?= (isset($user['nama'])) ? $user['nama'] : 'Pengunjung'; ?></b></span>
                </div>
            </div>
        </div>
    </nav>
